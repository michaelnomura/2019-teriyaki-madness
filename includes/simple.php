...
$toName = "Teriyaki Madness"; //place your client's name here
$website = "Teriyaki Madness";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	<!-- START HTML FORM -->
	<form class="large-form" action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="post">
	<div>
		<label>
			Name:<br /><input type="text" name="Name" required="required" placeholder="Full Name (required)" title="Name is required" tabindex="10" size="80" autofocus />
		</label>
	</div>
	<div>	
		<label>
			Email:<br /><input type="email" name="Email" required="required" placeholder="Email (required)" title="A valid email is required" tabindex="20" size="80" />
		</label>
	</div>
	<!-- below change the HTML to your form elements - only 'Name' & 'Email' (above) are significant -->
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="80" rows="30" placeholder="Your comments are important to us!" tabindex="30"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
	...
	<!-- END HTML FORM -->
	<!-- START HTML FORM  MOBILE-->
	<form class="small-form" action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="post">
	<div>
		<label>
	...
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="35" rows="30" placeholder="Your comments are important to us!" tabindex="30"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
    <div class="g-recaptcha" data-sitekey="<?=$siteKey;?>"></div> 
